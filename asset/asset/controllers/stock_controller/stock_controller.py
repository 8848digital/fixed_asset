...
class AssetStockController(StockController):
	def make_gl_entries(self, gl_entries=None, from_repost=False, via_landed_cost_voucher=False):
		asset_make_gl_entries(self, gl_entries, from_repost, via_landed_cost_voucher)

	def make_bundle_using_old_serial_batch_fields(
		self, table_name=None, via_landed_cost_voucher=False
	):
		asset_make_bundle_using_old_serial_batch_fields(self, table_name, via_landed_cost_voucher)
