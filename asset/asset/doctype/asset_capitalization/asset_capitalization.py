...
class AssetCapitalization(StockController):
	...
	if TYPE_CHECKING:
		...
		from asset.asset.doctype.asset_capitalization_asset_item.asset_capitalization_asset_item import (
			AssetCapitalizationAssetItem,
		)
		from asset.asset.doctype.asset_capitalization_service_item.asset_capitalization_service_item import (
			AssetCapitalizationServiceItem,
		)
		from asset.asset.doctype.asset_capitalization_stock_item.asset_capitalization_stock_item import (
