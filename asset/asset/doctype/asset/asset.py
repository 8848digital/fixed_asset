...
class Asset(AccountsController):
	...
	if TYPE_CHECKING:
		...
		from asset.asset.doctype.asset_finance_book.asset_finance_book import AssetFinanceBook
	...
	def make_gl_entries(self):
		...
		if (
			purchase_document and self.purchase_amount and getdate(self.available_for_use_date) <= getdate()
		):
			gl_entries.append(
				self.get_gl_dict(
					{
