...
def execute():
	frappe.reload_doc("asset", "doctype", "asset_finance_book")
	frappe.reload_doc("asset", "doctype", "depreciation_schedule")
	frappe.reload_doc("asset", "doctype", "asset_category")
	frappe.reload_doc("asset", "doctype", "asset")
	frappe.reload_doc("asset", "doctype", "asset_movement")
	frappe.reload_doc("asset", "doctype", "asset_category_account")
